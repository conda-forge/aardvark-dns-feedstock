...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/aardvark-dns-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/aardvark-dns-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add aardvark-dns
# for installing globally
pixi global install aardvark-dns
```
...
It is possible to list all of the versions of `aardvark-dns` available on your platform:
...
```
pixi search aardvark-dns --channel conda-forge
```
